  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-md shadow-md">
      ...
      <div className="flex flex-col gap-4 mt-4">
        <div className="bg-blue-500/20 dark:bg-blue-800/60 p-4 rounded-lg shadow">
        ...
        <div className="bg-purple-500/20 dark:bg-purple-800/60 rounded-lg p-4 shadow">
          <div className="flex items-center justify-between gap-1">
            <h2 className="font-medium text-gray-800 dark:text-gray-200">Lorem ipsum dolor sit</h2>
            <span className="text-xs text-gray-600 dark:text-green-300 bg-white dark:bg-gray-700 rounded-lg px-1 py-1">
              2020-01-01
        ...
        <div className="bg-yellow-500/20 dark:bg-red-400/60 rounded-lg p-4 shadow">
          <div className="flex items-center justify-between gap-1">
            <h2 className="font-medium text-gray-800 dark:text-gray-200">Lorem ipsum dolor sit</h2>
            <span className="text-xs text-gray-600 dark:text-green-300 bg-white dark:bg-gray-700 rounded-lg px-1 py-1">
              2020-01-01
