    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* USER INFO CARD */}
          <div className="bg-purple-100 dark:bg-blue-900 rounded-xl py-6 px-4 flex-1 flex gap-4">
            <div className="w-1/3">
              <Image
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium text-gray-600 dark:text-gray-300">
      ...
      <div className="w-full xl:w-1/3 flex flex-col">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-md">
          ...
          <div className="flex mt-4 gap-4 flex-wrap text-xs text-gray-500 dark:text-gray-300">
            <Link className="p-2 rounded-md bg-blue-50 dark:bg-blue-900/50" href="/">Student&apos;s Classes</Link>
            <Link className="p-2 rounded-md bg-yellow-50 dark:bg-green-900/50" href={`/list/teachers?classId=${2}`}>Student&apos;s Teachers</Link>
            <Link className="p-2 rounded-md bg-purple-50 dark:bg-purple-900/50" href="/">Student&apos;s Lessons</Link>
            <Link className="p-2 rounded-md bg-red-50 dark:bg-red-900/50" href="/">Student&apos;s Exams</Link>
            <Link className="p-2 rounded-md bg-gray-100 dark:bg-gray-900/50" href="/">Student&apos;s Assignments</Link>
          </div>
        </div>
        <Performance />
        <Announcements />
