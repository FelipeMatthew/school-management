...
const StudentsListPage = () => {
  const renderRow = (item: StudentType) => (
    ...
    >
      ...
      <td className="hidden md:table-cell text-black dark:text-white">{item.studentId}</td>
      <td className="hidden md:table-cell text-black dark:text-white">{item.grade}</td>
  ...
  return (
    <div className="bg-white dark:bg-gray-950 p-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-md flex-1 mt-0">
      ...
      <div className="flex justify-between items-center">
        <h1 className="hidden md:block text-lg font-semibold text-black dark:text-white">All Students</h1>
